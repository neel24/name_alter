 ...
 *   description = @Translation("Replaces any instance of the "[name:FIRSTNAME:LASTNAME]" token to "Name:LASTNAME FIRSTNAME"."),
...
class FilterNameAlter extends FilterBase {
  ...
  public function process($text, $langcode) {
    ...
    $regex = '/\[name:FIRSTNAME:LASTNAME\]/';
    $replacement = "Name: LASTNAME FIRSTNAME";
